...
```
{
    ...
    "components": [
        {
            "componentArn": "arn:aws:imagebuilder:us-west-2:12345678912:component/my-example-component/2019.12.02/1"
        },
        {
            "componentArn": "arn:aws:imagebuilder:us-west-2:12345678912:component/my-imported-component/1.0.0/1"
        }
    ],
...
```
{
    ...
    "imageRecipeArn": "arn:aws:imagebuilder:us-west-2:12345678912:image-recipe/my-example-recipe/2019.12.03",
    "infrastructureConfigurationArn": "arn:aws:imagebuilder:us-west-2:12345678912:infrastructure-configuration/my-example-infrastructure-configuration",
    "distributionConfigurationArn": "arn:aws:imagebuilder:us-west-2:12345678912:distribution-configuration/my-example-distribution-configuration",
...
```
aws imagebuilder cancel-image-creation —image-build-version-arn arn:aws:imagebuilder:us-west-2:647823116501:image/my-example-recipe/2019.12.03/1
```
...
```
aws imagebuilder put-component-policy --component-arn arn:aws:imagebuilder:us-west-2:647823116501:component/my-example-component/2019.12.03 --policy '{ "Version": "2012-10-17", "Statement": [ { "Effect": "Allow", "Principal": { "AWS": [ "arn:aws:iam::account-id:user/Alice", "account-id-2" ] }, "Action": "imagebuilder:GetComponent", "Resource": [ "arn:aws:imagebuilder:us-west-2:647823116501:component/my-example-component/2019.12.02" ] } ] }'
```
...
```
aws imagebuilder put-image-recipe-policy --component-arn arn:aws:imagebuilder:us-west-2:647823116501:image-recipe/my-example-image-recipe/2019.12.03 --policy '{ "Version": "2012-10-17", "Statement": [ { "Effect": "Allow", "Principal": { "AWS": [ "arn:aws:iam::account-id:user/Alice", "account-id-2" ] }, "Action": "imagebuilder:GetComponent", "Resource": [ "arn:aws:imagebuilder:us-west-2:647823116501:image-recipe/my-example-image-recipe/2019.12.03" ] } ] }'
```
...
```
aws imagebuilder put-image-policy --component-arn arn:aws:imagebuilder:us-west-2:647823116501:image/my-example-image/2019.12.03 --policy '{ "Version": "2012-10-17", "Statement": [ { "Effect": "Allow", "Principal": { "AWS": [ "arn:aws:iam::account-id:user/Alice", "account-id-2" ] }, "Action": "imagebuilder:GetComponent", "Resource": [ "arn:aws:imagebuilder:us-west-2:647823116501:image/my-example-image/2019.12.03" ] } ] }'
```
...
```
    {
    "imagePipelineArn": "arn:aws:imagebuilder:us-west-2:647823116501:image-pipeline/my-example-pipeline",
    "description": "Builds Windows 2016 Images",
    "imageRecipeArn": "arn:aws:imagebuilder:us-west-2:12345678912:image-recipe/my-example-recipe/2019.12.08",
    "infrastructureConfigurationArn": "arn:aws:imagebuilder:us-west-2:12345678912:infrastructure-configuration/my-example-infrastructure-configuration",
    "distributionConfigurationArn": "arn:aws:imagebuilder:us-west-2:12345678912:distribution-configuration/my-example-distribution-configuration",
    "imageTestsConfiguration": {
        "imageTestsEnabled": true,
...
```
aws imagebuilder start-image-pipeline-execution --image-pipeline-arn arn:aws:imagebuilder:us-west-2:647823116501:image-pipeline/my-example-pipeline
```
...
```
{
    "resourceArn": "arn:aws:imagebuilder:us-west-2:647823116501:image-pipeline/my-example-pipeline",
    "tags": {
        "KeyName": "KeyValue"
    }
}
...
```
aws imagebuilder delete-component --component-build-version-arn arn:aws:imagebuilder:us-west-2:12345678912:component/my-example-component/2019.12.02/1
```
...
```
aws imagebuilder delete-distribution-configuration --distribution-configuration-arn arn:aws:imagebuilder:us-west-2:12345678912:distribution-configuration/my-example-distribution-configuration
```
...
```
aws imagebuilder delete-image --image-build-version-arn arn:aws:imagebuilder:us-west-2:12345678912:image/my-example-image/2019.12.02/1
```
...
```
aws imagebuilder delete-image-pipeline --image-pipeline-arn arn:aws:imagebuilder:us-west-2:647823116501:image-pipeline/my-example-pipeline
```
...
```
aws imagebuilder delete-infrastructure-configuration --infrastructure-configuration-arn arn:aws:imagebuilder:us-west-2:12345678912:infrastructure-configuration/my-example-infrastructure-configuration
```
...
```
aws imagebuilder get-component --component-build-version-arn arn:aws:imagebuilder:us-west-2:12345678912:component/my-example-component/2019.12.02/1
```
...
```
aws imagebuilder get-component-policy --component-arn arn:aws:imagebuilder:us-west-2:12345678912:component/my-example-component/2019.12.02
```
...
```
aws imagebuilder get-distribution-configuration --distribution-configuration-arn arn:aws:imagebuilder:us-west-2:12345678912:distribution-configuration/my-example-distribution-configuration
```
...
```
aws imagebuilder get-image --image-build-version-arn arn:aws:imagebuilder:us-west-2:12345678912:image/my-example-image/2019.12.02/1
```
...
```
aws imagebuilder get-image-pipeline --image-recipe-arn arn:aws:imagebuilder:us-west-2:123456789012:image-recipe/my-example-recipe/2019.12.03
```
...
```
aws imagebuilder get-image-policy --image-arn arn:aws:imagebuilder:us-west-2:12345678912:image/my-example-image/2019.12.02
```
...
```
aws imagebuilder get-infrastructure-configuration --infrastructure-configuration-arn arn:aws:imagebuilder:us-west-2:12345678912:infrastructure-configuration/my-example-infrastructure-configuration
```
...
```
aws imagebuilder list-component-build-versions --component-version-arn arn:aws:imagebuilder:us-west-2:647823116501:component/my-example-component/2019.12.03
```
...
```
aws imagebuilder list-distribution-configurations --distribution-configuration-arn arn:aws:imagebuilder:us-west-2:12345678912:distribution-configuration/my-example-distribution-configuration
```
...
```
aws imagebuilder list-image-build-versions --image-version-arn arn:aws:imagebuilder:us-west-2:647823116501:image/my-example-image/2019.12.03
```
...
```
aws imagebuilder list-image-pipeline-images --image-pipeline-arn arn:aws:imagebuilder:us-west-2:647823116501:image-pipeline/my-example-pipeline
```
...
```
aws imagebuilder list-tags-for-resource —resource-arn arn:aws:imagebuilder:us-west-2:647823116501:image-pipeline/my-example-pipeline
```
