...
| [Feature release: CVE detection and reporting](#doc-history) | For accounts that have activated Amazon Inspector scans, Image Builder can capture the common vulnerability and exposures \(CVE\) findings from Amazon Inspector during the build process for new images, including container images stored in Amazon ECR\. Image Builder creates a snapshot of the findings to support detail analysis\. Image Builder also reports on findings counts that can be filtered by account, by pipeline, or by image, with the ability to drill down on details\. | March 30, 2023 | 
| [Added version history](toe-stig.md) | Added version history to the Windows and Linux sections\. | February 17, 2023 | 
| [New STIG Versions](toe-stig.md) | Updated STIG versions and applied STIGS for 2022 fourth quarter release\. | February 1, 2023 | 
