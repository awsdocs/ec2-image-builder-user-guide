# Import a VM image<a name="import-vm-image"></a>
...
1. Provide details for the following sections on the **Import image** page\. Then choose **Import image** when you're done\.

### General<a name="import-vm-image-console-general"></a>
...
### Base image operating system<a name="import-vm-image-console-base-os"></a>
